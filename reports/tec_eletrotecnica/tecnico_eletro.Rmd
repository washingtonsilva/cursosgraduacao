---
title: "Estatísticas Educacionais: Curso Técnico Integrado em Eletrotécnica"
description: |
  Relatório com estatísticas educacionais d cursos ofertados pelo 
  IFMG - Campus Formiga
author:
...
p1 <- ggplot(data = eletro, aes(x = periodo_letivo, y = matriculas_iniciais, 
...
p2 <- ggplot(data = eletro, aes(x = periodo_letivo, y = concluintes, group = curso)) + geom_point() + geom_line() 
...
p3 <- ggplot(data = eletro, aes(x = periodo_letivo, y = retidos, group = curso)) + geom_point() + geom_line() 
...
p4 <- ggplot(data = eletro, aes(x = periodo_letivo, y = taxa_retencao, group = curso)) + geom_point() + geom_line() 
...
p5 <- ggplot(data = eletro, aes(x = periodo_letivo, y = evasao, group = curso)) + geom_point() + geom_line() 
...
p6 <- ggplot(data = eletro, aes(x = periodo_letivo, y = taxa_evasao, group = curso)) + geom_point() + geom_line() 

p6 <- p6 + labs(title = "Técnico Integrado em Eletrotécnica") +
